...
namespace ServerGUI.ViewModel
{
    public class StatusViewModel : ViewModelBase
    {
        ...
        public StatusViewModel(SettingsViewModel settingsViewModel, IServiceHelper serviceHelper, IDialogHelper dialogHelper)
        {
        ...
        public async Task CheckAsync()
        {
            ...
            try
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    {
                        var port = settingsViewModel.Settings.Port;
                        ...
                        var ipAddress = settingsViewModel.Settings.IPv6 ? "::1" : "127.0.0.1";
